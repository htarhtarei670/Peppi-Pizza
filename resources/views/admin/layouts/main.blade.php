        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#" class="d-flex justify-content-center text-decoration-none">
                    <img src="{{ asset('admin/images/icon/pizza logo.png') }}" class="pizza" />
                    <h4 class="text-danger align-self-center ps-3">PEPPIPIZZA</h4>
                </a>
            </div>
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        <li>
                            <a href="{{ route('cate#list') }}" class="text-decoration-none">
                        ...
                        <li>
                            <a href="{{ route('admin#contact') }}">
                                <i class="fa-solid fa-comment-sms"></i>Contact Messages
                            </a>
                        </li>
                    </ul>
                </nav>
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <span class="email text-decoration-none">{{ Auth::user()->email }}</span>
                                                </div>
                                            </div>
                                            <div class="account-dropdown__body">
                                                <div class="account-dropdown__item">
                                                    <a href="{{ route('admin#detail') }}" class="text-decoration-none">
                                            ...
                                            <div class="account-dropdown__body">
                                                <div class="account-dropdown__item">
                                                    <a href="{{ route('admin#list') }}" class="text-decoration-none">
                                                        <i class="fa-solid fa-users"></i></i>Admin List</a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="account-dropdown__footer ">
                                                <form action="{{ route('logout') }}" method="POST"
                                                    ...
                                                    @csrf
                                                    <input type="submit" class="btn bg-dark text-white col-10"
                                                        value="Log Out">
                                                </form>
                                            </div>
                                        </div>
